...
var mygallery=new fadeSlideShow({
	...
	imagearray: [
		["<?php echo base_url(); ?>slideshow_images/1.jpg", "", "", "Flower - A description"],
		["<?php echo base_url(); ?>slideshow_images/2.jpg", "", "", "Another Description!"] //<--no trailing comma after very last image element!
	],
