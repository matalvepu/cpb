...
class AddForecast extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('adminBodies/addForecastForm');
	...
	function insert()
	{
		...
		else
		{
			...
			if($this->input->post('upload'))
			{
			   ...
			   $this->forecast_model->insertForecastData();
			}
			
			$data['msg']="****You successfully inserted the forecast data****";
			$this->load->view('eng_segments/normal_head');
